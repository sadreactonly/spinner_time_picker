...
Future<TimeOfDay?> showSpinnerTimePicker(BuildContext context,
    {
    ...
    ButtonOrder? buttonOrder = ButtonOrder.saveCancel}) async {
  ...
  final actionsButtons = buttonOrder == ButtonOrder.saveCancel
      ? <Widget>[saveButton, cancelButton]
