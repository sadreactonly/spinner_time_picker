...
//   final int initSelectedIndex; // Initial selected item index
//   final List<T> items; // List of items should be shown
//   final String Function(dynamic item) itemToLabel; // item to string label function
//   final double height; // Height of the widget
//   final double width; // Width of the widget
//   final double itemHeight; // Height of individual items
//   final TextStyle selectedTextStyle; // Text style for selected items
//   final TextStyle nonSelectedTextStyle; // Text style for non-selected items
//   final Color spinnerBgColor; // Background color of the widget
//   final void Function(dynamic item) onSelectedItemChanged; // Callback for value selection
...
//             return Center(
//               child: Text(
//                 widget.itemToLabel(wrappedItem), // Display with leading zero
//                 style: wrappedIndex == _selectedIndex ? widget.selectedTextStyle : widget.nonSelectedTextStyle,
//               ),
//             );
//           },
//         ),
